...
You can buy a Google Voice number or an international roaming card. I chose a Hong Kong Greater Bay Area prepaid SIM card. This card works normally in mainland China for browsing Google and Twitter, but its main purpose is receiving verification SMS from foreign websites. Since it can't be replaced if lost, I basically never take it out — it just sits in an idle phone at home.

**2. Register a ProtonMail anonymous email account.**

This email service uses end-to-end encryption, its servers are in the neutral country of Switzerland, and it's protected by Swiss privacy law. Registration doesn't require a phone number.

**3. Use the SIM card, email, and different avatars and IDs to register for the services you need.**

For example, registering a privacy-protected domain, Twitter, servers, and a Hong Kong PayPal. PayPal can't receive funds into it — you can only link your own Visa card for payments. I'm not doing anything wrong, so I'm not worried about PayPal leaking bank information. If you're concerned, you can choose to pay for services with cryptocurrency.

After doing all of the above, your domestic and foreign accounts have almost no connection, and cross-referencing can't reveal accurate information. You're basically in an anonymous state.

Anonymity isn't for speaking recklessly. When power has eroded the space for free speech, when threats and intimidation target personal expression, anonymity is simply about defending freedom of speech. When nationalism and mob violence suppress individual existence, anonymity is simply about ensuring personal safety.

**Here are the practical results:**

1. In March 2020, Weibo leaked a large number of users' phone numbers. But since I had bound a foreign phone number and had cleared my data, there was no impact.
